...
2. the `n_z_0_t_1 = sum(F_age %*% n_z_age_t)`. This takes the place of the $\sum_{a = 0}^{M}...$ in Eq. 1 above. We don't need to supply $a=0$ and $M$ as those are inferred in the `levels_ages` list.
