...
Here, we refer to these different scales (parameters (e.g. $\alpha_g,\beta_g$ in Eq 6), regressions (e.g. Eq 4), sub-kernels (e.g. Eq 3), and projection kernels (e.g. Eq 2)) as levels of the _model hierarchy_. Since their introduction in 2000 by Easterling and colleagues, the theory supporting IPMs and their application has been expanded substantially. Examples include the general, deterministic IPM that allows for a mixture of multiple discrete and/or continuous state variables (Ellner & Rees 2006), stochastically varying parameters to generate unique kernels (Childs et al. 2004, Rees & Ellner 2009), and spatially explicit IPMs (Jongejans et al. 2011).
