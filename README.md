...
Density dependent versions are completed for simple and general ones.
These are probably stable, but not sufficiently tested to be certain.
...
# it starts on (i.e. the size/weight/etc from above), and what state
...
# models will be more complicated. This information is used to automatically
# generate an iteration procedure for the model, and so is very important!
