...
.iterate_kerns <- function(proto_ipm, ...) {

  UseMethod('.iterate_kerns')
}


.iterate_kerns.simple_di_det <- function(proto_ipm,
                                         iterators,
                                         sub_kern_list,
                                         iterations,
                                         current_iteration,
...
.iterate_kerns.simple_di_stoch_kern <- function(proto_ipm,
                                                iterators,
                                                sub_kern_list,
                                                iterations,
                                                kern_seq,
...
.iterate_kerns.simple_di_stoch_param <- function(proto_ipm,
                                                iterators,
                                                sub_kern_list,
                                                current_iteration,
                                                kern_seq,
...
.iterate_kerns.general_di_det <- function(proto_ipm,
                                          k_row,
                                          sub_kern_list,
                                          iterations,
                                          current_iteration,
...
.iterate_kerns.general_di_stoch_kern <- function(proto_ipm,
                                                 k_row,
                                                 sub_kern_list,
                                                 iterations,
                                                 kern_seq,
...
.iterate_kerns.general_di_stoch_param <- function(proto_ipm,
                                                  k_row,
                                                  sub_kern_list,
                                                  current_iteration,
                                                  kern_seq,
