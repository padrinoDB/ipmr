...
Examples of more complicated models are included in the vignettes, accesible either using `browseVignettes('ipmr')` or by visiting the Articles tab on [project's webpage](https://levisc8.github.io/ipmr/). Please file all bug reports in the Issues tab of this repository or contact me via [email]<levisc8@@gmail.com> with a reproducible example.
