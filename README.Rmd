...
Simple, density-independent, deterministic models (`simple_di_det`) are now functional. However, expect changes as more complicated methods are implemented! See below for an example of how to implement an IPM in this framework.

Next on the implementation to-do list are simple, stochastic IPMs using either parameter resampling or kernel resampling. 
