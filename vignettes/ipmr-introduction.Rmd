...
The example uses the `mvtnorm` library to access the `rmvnorm` function for generating parameter estimates from a multivariate normal distribution during each model iteration.
...
# In this case, we also define a wrapper function around rmvnorm to make sure
