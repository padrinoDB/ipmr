...
Again, we've add the `f_s_dd * sum(n_size_t) * d_size` to the expression fof `f_s_yr`, but otherwise, not much is different from how we've defined density independent models. The rest of the model definition process is unchanged.
