...
- [`kernel_formulae()`](https://levisc8.github.io/ipmr/reference/proto_accessors.html)

- [`vital_rates()`](https://levisc8.github.io/ipmr/reference/proto_accessors.html)

- [`domains()`](https://levisc8.github.io/ipmr/reference/proto_accessors.html)

- [`int_mesh()`](https://levisc8.github.io/ipmr/reference/ipm_accessors.html)
